...
<body class="">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li>
                    <a href="{{route('logout')}}">
                        <i class="fa fa-sign-out"></i> Cierrar Sesion
                    </a>
                </li>
            </ul>
    ...
    <script src="{{asset('public/master/js/plugins/metisMenu/jquery.metisMenu.js')}}"></script>
    <script src="{{asset('public/master/js/plugins/slimscroll/jquery.slimscroll.min.js')}}"></script>

    <!-- Custom and plugin javascript -->
    <script src="{{asset('public/master/js/inspinia.js')}}"></script>
    <script src="{{asset('public/master/js/plugins/pace/pace.min.js')}}"></script>
